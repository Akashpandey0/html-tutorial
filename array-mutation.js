...
const calculateWelthButton = document.getElementById('wealth');

let data = [
    { name: 'Akash Pandey', money: 130000.0 },
    { name: 'Vaibhav Singh', money: 200000.0 },
    { name: 'Aditya Singh', money: 170000.0 }
  ];
